...
@interface HPPlayerControllerView ()
...
@implementation HPPlayerControllerView
...
- (UIButton *)startBtn
{
    if (!_startBtn) {
        ...
        [_startBtn setImage:[UIImage imageNamed:@"player-pause"] forState:UIControlStateSelected];
    }
    return _startBtn;
}
...
- (UIButton *)fullScreenBtn
{
    if (!_fullScreenBtn) {
        ...
        [_fullScreenBtn setImage:[UIImage imageNamed:@"player-fullscreen"] forState:UIControlStateNormal];
...
- (UIButton *)playeBtn
{
    if (!_playeBtn) {
        ...
        [_playeBtn setImage:[UIImage imageNamed:@"startBtn"] forState:UIControlStateNormal];
    }
    return _playeBtn;
}
